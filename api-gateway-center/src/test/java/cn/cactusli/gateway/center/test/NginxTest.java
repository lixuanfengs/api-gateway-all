...
import static cn.cactusli.gateway.center.test.CopyExample.unTar;
...
public class NginxTest {
    ...
    public void xx() throws Exception{
        ...
        ExecCreateCmdResponse execCreateCmdResponse = dockerClient
                .execCreateCmd(containerId)
                .withCmd("docker", "cp", "/nginx.conf", "/opt/api-gateway/api-gateway-center/doc/data/nginx/")
                .exec();
